package LinkedListsWithNodes;

import IndexListWithArrays.IndexList;

public class LinkedListIndexListClassVer<T> implements IndexList<T> {
	...
	public LinkedListIndexListClassVer() {
		this.header = null;
		this.size = 0;
	}
	...
	public void print() {
		for(int i = 0; i < this.size-1; i++)
			System.out.print(this.findNode(i).getElement() + ", ");
		
		System.out.println(this.findNode(size-1).getElement());
