...
public class SLWithCircularArraysClassVer<T> implements SimpleList<T> {
	private T[] elements;
	private int size;
	...
	public SLWithCircularArraysClassVer() {
	...
	public void print()
	{
		for(int i = 0, j = firstPosition; i < size; 
				i++, firstPosition = this.nextPosition(firstPosition))
