package IndexListWithArrays;

import LinkedListsWithNodes.LinkedListIndexListMyVer;
import LinkedListsWithNodes.LinkedListIndexListClassVer;
...
//		System.out.println(List.get(List.size()-1));
		...
		IndexList<String> L1 = new LinkedListIndexListClassVer<String>();
		IndexList<String> L2 = new LinkedListIndexListMyVer<String>();
